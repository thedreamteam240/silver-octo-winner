...
const Button_create = () => (
	<Dialog.Root>
		<Dialog.Trigger asChild>
			<button className="inline-flex h-[35px] items-center justify-center border border-black rounded-xl rounded bg-gray-300 px-[15px] font-medium leading-none text-violet11 outline-none outline-offset-1 hover:bg-mauve3 focus-visible:outline-2 focus-visible:outline-violet6 select-none">
				+ New Story
			</button>
		</Dialog.Trigger>
		<Dialog.Portal>
